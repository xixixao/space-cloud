...
(function() {
  ...
  module.exports = function(app) {
    var addEvent, findAnswer, findCommentA, findCommentQ, findFile, findQuestion, findTopic, fromArrayToMap, getEvents, getOwners, getTopic, objectify, usersFiles;

    app.get('/users/:login', authenticated, function(request, response) {
    ...
    app.post('/users/:login', authenticated, function(request, response) {
      request.user.update({
        name: request.body.name,
        password: request.body.password
      });
