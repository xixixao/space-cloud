...
(function() {
  ...
  module.exports = function(app) {
    var addEvent, findAnswer, findCommentA, findCommentQ, findFile, findQuestion, findTopic, fromArrayToMap, getEvents, getTopic, objectify, usersFiles;
    ...
    objectify = function(topic) {
      ...
      return topic.files = fromArrayToMap('_id', topic.files);
    };
