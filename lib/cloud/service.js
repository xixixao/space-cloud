...
(function() {
  var Answer, CommentA, CommentQ, File, LocalStrategy, Q, Question, Topic, User, passport, _ref;
  ...
  module.exports = function(app) {
    ...
    app.get('/feeds/:user', function(request, response) {
      return Q.ninvoke(User.findOne({
        _id: request.params.user
      }).select('topics.code'), 'exec').then(function(_arg) {
