...
(function() {
  var Comment, Course, File, Question, User, _ref;

  _ref = require('./model'), Course = _ref.Course, User = _ref.User, File = _ref.File, Comment = _ref.Comment, Question = _ref.Question;
  ...
  module.exports = function(app) {
    ...
    return app.get('/comments/:code', function(request, response) {
      return Comment.find({
        _id: request.params.code
      }, function(err, docs) {
        if (err != null) {
