...
(function() {
  var Answer, CommentA, CommentQ, Event, File, Q, Question, Topic, User, authenticated, canRead, canWrite, passport, path, _ref, _ref1;
  ...
  module.exports = function(app) {
    var addEvent, batchUserData, findAnswer, findCommentA, findCommentQ, findFile, findQuestion, findTopic, fromArrayToMap, getAnswer, getEvents, getOwners, getTopic, objectify, usersFiles;
    ...
    app.post('/topics/:topicId/upload', authenticated, function(request, response) {
      return response.send((function() {
        ...
        _ref2 = request.files.form.files[0];
        _results = [];
        for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
          file = _ref2[_i];
          console.log(file);
