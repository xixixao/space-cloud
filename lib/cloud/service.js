...
(function() {
  ...
  module.exports = function(app) {
    ...
    addEvent = function(type, model, link, topicCode) {
      var event, item, _i, _len;
    ...
    app.get('/events', authenticated, function(request, response) {
      ...
      return Q.ninvoke(Event.find({}).where('topicCode')["in"](topicCodes).sort('-timestamp'), 'exec').then(function(events) {
